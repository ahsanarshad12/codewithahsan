...
const HireMeSection = () => {
  ...
  const validateForm = () => {
    ...
    if (!formData.message.trim()) {
      ...
      newErrors.message = "Please provide more details about your project (minimum 50 characters)";
      valid = false;
    }
    ...
    <section id="hire" className="relative min-h-screen overflow-hidden bg-gradient-to-br from-gray-900 via-black to-gray-950 py-20">
      ...
      <div className="relative z-10 container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-16 lg:mb-20">
          ...
          >
            ...
            <p className="text-gray-400 text-lg max-w-2xl mx-auto leading-relaxed">
              Have a project in mind? Let's collaborate to bring your vision to life with cutting-edge technology.
            </p>
          </motion.div>
        </div>
        ...
        {submitStatus === "success" && (
          ...
          >
            <div className="p-6 rounded-2xl bg-gradient-to-br from-green-500/20 to-emerald-500/10 backdrop-blur-sm border border-green-500/30">
              <div className="flex items-center gap-4">
                ...
                <div className="text-left">
                  ...
                  <p className="text-gray-300 text-sm">
                    I've received your project details. I'll review them and get back to you within 24 hours.
                  </p>
                </div>
              </div>
            </div>
                  ...
                  <div className="space-y-6">
                    ...
                    <div className="grid sm:grid-cols-2 gap-6">
                      <div>
                        ...
                        <input
                          ...
                          className={`w-full px-4 py-3 bg-gray-800/50 border rounded-xl focus:ring-2 focus:ring-amber-500/50 focus:border-amber-500/50 text-white placeholder-gray-500 transition-all duration-300 ${errors.name ? "border-red-500/50" : "border-gray-700/50"
                            }`}
                      ...
                      <div>
                        ...
                        <input
                          ...
                          onChange={handleChange}
                          className={`w-full px-4 py-3 bg-gray-800/50 border rounded-xl focus:ring-2 focus:ring-amber-500/50 focus:border-amber-500/50 text-white placeholder-gray-500 transition-all duration-300 ${errors.email ? "border-red-500/50" : "border-gray-700/50"
                            }`}
                    ...
                    <div className="grid sm:grid-cols-2 gap-6">
                      ...
                      <div>
                        ...
                        <select
                          ...
                          onChange={handleChange}
                          className="w-full px-4 py-3 bg-gray-800/50 border border-gray-700/50 rounded-xl focus:ring-2 focus:ring-amber-500/50 focus:border-amber-500/50 text-white transition-all duration-300"
                        >
                    ...
                    <div>
                      ...
                      <textarea
                        ...
                        onChange={handleChange}
                        rows={6}
                        className={`w-full px-4 py-3 bg-gray-800/50 border rounded-xl focus:ring-2 focus:ring-amber-500/50 focus:border-amber-500/50 text-white placeholder-gray-500 transition-all duration-300 ${errors.message ? "border-red-500/50" : "border-gray-700/50"
                          }`}
                        placeholder="Describe your project in detail, including goals, requirements, timeline, and any specific features needed..."
                      />
                      <div className="flex justify-between items-center mt-2">
                        ...
                        <span className="text-gray-500 text-sm">
                          {formData.message.length > 0 && `${formData.message.length}/1000`}
                        </span>
                      </div>
                    </div>
          ...
          >
            ...
            <div className="rounded-2xl bg-gradient-to-br from-gray-900/50 to-black/50 backdrop-blur-sm border border-gray-800 p-6">
              ...
              <p className="text-gray-400 text-sm mb-4">
                Prefer to talk directly? Reach out via:
              </p>
              <div className="space-y-3">
                <a
                  ...
                  className="flex items-center gap-3 p-3 rounded-lg bg-gradient-to-r from-green-600/20 to-emerald-600/10 hover:from-green-600/30 hover:to-emerald-600/20 border border-green-600/30 transition-all duration-300"
                >
                ...
                <a
                  ...
                  className="flex items-center gap-3 p-3 rounded-lg bg-gradient-to-r from-red-600/20 to-pink-600/10 hover:from-red-600/30 hover:to-pink-600/20 border border-red-600/30 transition-all duration-300"
                >
        ...
        >
          <p className="text-gray-500 text-sm">
            All inquiries are confidential. I typically respond within 24 hours.
          </p>
        </motion.div>
      </div>
    </section>
