    ...
    <footer className="relative overflow-hidden bg-gradient-to-br from-gray-900 via-black to-gray-950">
      ...
      <div className="relative z-10 container mx-auto px-4 sm:px-6 lg:px-8 py-12 lg:py-16">
        ...
        <div className="flex flex-col md:flex-row justify-between items-center gap-4">
          ...
          <button
            onClick={scrollToTop}
            className="group flex items-center gap-2 px-4 py-2 rounded-lg bg-gray-900/50 backdrop-blur-sm border border-gray-800/50 hover:border-cyan-500/50 transition-all duration-300"
          >
            <span className="text-gray-400 text-sm group-hover:text-cyan-300 transition-colors">
              Back to top
            </span>
            <FaArrowUp className="w-4 h-4 text-gray-400 group-hover:text-cyan-300 group-hover:animate-bounce transition-colors" />
          </button>
        </div>
